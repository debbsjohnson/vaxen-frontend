...
export function DashboardPreview() {
	...
	// Calculate total balance from currency balances
	const calculateTotalBalance = () => {
		let total = 0;
		const usdToOtherRates: Record<string, number> = {
			USD: 1.0,
		...
		dashboardData.balances.forEach(balance => {
			const amount = parseFloat(balance.amount.replace(/,/g, ""));
			const rate = usdToOtherRates[balance.currency] || 1.0;
			total += amount * rate;
		});
		...
		>
			...
			<div className="absolute inset-0 overflow-hidden pointer-events-none">
				<div
					...
					style={{
						background:
							"radial-gradient(circle, rgba(12, 37, 115, 0.4) 0%, transparent 70%)",
						filter: "blur(80px)",
					}}
				/>
			</div>
            ...
            `}
						style={{
							...
							boxShadow:
								"0 0 30px rgba(12, 37, 115, 0.2), inset 0 0 20px rgba(12, 37, 115, 0.05)",
						}}
					>
						<div className="flex items-center gap-3 mb-4">
							<div
								...
								style={{
									background:
										"linear-gradient(135deg, #0C2573 0%, #BA0827 100%)",
								}}
							>
            ...
            `}
				...
				<div className="text-center mb-16">
					...
					<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
						Get a glimpse of your unified treasury dashboard. Manage all your
						currencies, track balances, and execute transactions from one
						powerful interface.
					</p>
				</div>
          ...
          `}
					style={{
						boxShadow:
							"0 0 60px rgba(12, 37, 115, 0.3), inset 0 0 40px rgba(12, 37, 115, 0.1)",
					}}
				>
					...
					<div
						...
						style={{
							background:
								"linear-gradient(135deg, rgba(12, 37, 115, 0.2) 0%, rgba(186, 8, 39, 0.2) 100%)",
						}}
					>
              ...
              `}
							style={{
								background:
									"linear-gradient(135deg, #0C2573 0%, #190326 50%, #BA0827 100%)",
								boxShadow:
									"0 0 40px rgba(12, 37, 115, 0.5), inset 0 0 30px rgba(186, 8, 39, 0.2)",
								transitionDelay: "1000ms",
								animation: dashboardVisible
                  ...
                  `}
									style={{
										...
										boxShadow:
											"0 0 20px rgba(12, 37, 115, 0.1), inset 0 0 20px rgba(12, 37, 115, 0.05)",
									}}
									onMouseEnter={e => {
										e.currentTarget.style.boxShadow =
											"0 0 30px rgba(12, 37, 115, 0.3), inset 0 0 20px rgba(12, 37, 115, 0.1)";
									}}
									onMouseLeave={e => {
										e.currentTarget.style.boxShadow =
											"0 0 20px rgba(12, 37, 115, 0.1), inset 0 0 20px rgba(12, 37, 115, 0.05)";
								...
								>
									...
									<p
										className={`text-xs font-medium ${balance.changeType === "positive" ? "text-green-400" : "text-red-400"}`}
									>
										{balance.change}
									</p>
								</div>
				...
				<div className="text-center mt-12">
					...
					<button
						...
						style={{
							background:
								"linear-gradient(135deg, rgba(12, 37, 115, 0.25) 0%, rgba(186, 8, 39, 0.25) 100%)",
							backdropFilter: "blur(30px) saturate(200%)",
							WebkitBackdropFilter: "blur(30px) saturate(200%)",
							border: "1px solid rgba(255, 255, 255, 0.3)",
							boxShadow:
								"0 8px 32px rgba(12, 37, 115, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.1), inset 0 -1px 0 rgba(0, 0, 0, 0.1)",
						}}
					>
						Request Access
					</button>
